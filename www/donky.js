cordova.define("cordova-plugin-donky-push.donky-core", function (require, exports, module) {
    var Donky = (function () {
        ...
        Donky.getRegistrationDetails = function (success, error) {
            var mysuccess = success;
            return cordova.exec(function (message) {
                mysuccess(JSON.parse(message));
            }, error, 'DonkyPlugin', 'getRegistrationDetails', []);
        }
