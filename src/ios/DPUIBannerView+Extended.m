...
static NSString *const DPUIButtonSetInteractionType = @"interactionType";

@interface DPUIBannerViewExtended ()
@property(nonatomic, strong) UIView *backgroundView;
@property(nonatomic, strong) UIView *buttonBorder;
@property(nonatomic, strong) DPUINotification *notification;
@end

@implementation DPUIBannerViewExtended
...
- (UIButton *)getButtonWithTag:(NSInteger)tag {
    ...
    NSArray *buttonActions = mobile[DPUIButtonSetActions];
    BOOL isSingleButton = [mobile[DPUIButtonSetInteractionType] isEqualToString:@"OneButton"];
